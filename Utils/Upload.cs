...
namespace Api_SistemaCursosDistancia.Utils
{
    ...
    {
        // Upload.
        public static string UploadFile(IFormFile escolhaArquivo, string[] extencoesPermitidas, string diretorio)
        {
            try
            {
                ...
                if (escolhaArquivo.Length > 0)
                {
                    ...
                    string nomeArquivo = ContentDispositionHeaderValue.Parse(escolhaArquivo.ContentDisposition).FileName.Trim('"');
